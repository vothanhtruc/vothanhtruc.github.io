...
// check user ---------------------------------------------------------------------------------------------------
	$('#user-name').blur(function() {
		var user = $('#user-name').val().length;
		if (user <= 8) {
			$('#error-user').text("Username length min 8 letter");
		} else {
			$('#error-user').text("");
		}
	});
...
// check password------------------------------------------------------------------------------------------------
	$('#password').blur(function() {
		...
		if (password <= 8) {
			$('#error-password').text("Password length min 8 letter");
		} else {
			$('#error-password').text("");
		}
	});
...
// check email---------------------------------------------------------------------------------------------------
	$('#email').blur(function() {
		...
		if (email.search("@") < 1 || email.lastIndexOf(".") < email.search("@") + 2
			...
			$('#error-email').text("Email wrong format");
		} else {
			$('#error-email').text("");
		}
	});
